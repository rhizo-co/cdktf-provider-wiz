...
- [automationRuleJiraTransitionTicket](./automationRuleJiraTransitionTicket.typescript.md)
- [automationRuleServicenowCreateTicket](./automationRuleServicenowCreateTicket.typescript.md)
- [automationRuleServicenowUpdateTicket](./automationRuleServicenowUpdateTicket.typescript.md)
- [cicdScanPolicy](./cicdScanPolicy.typescript.md)
...
- [dataWizCloudConfigRules](./dataWizCloudConfigRules.typescript.md)
- [dataWizHostConfigRules](./dataWizHostConfigRules.typescript.md)
- [dataWizKubernetesClusters](./dataWizKubernetesClusters.typescript.md)
- [dataWizOrganizations](./dataWizOrganizations.typescript.md)
- [dataWizSubscriptionResourceGroups](./dataWizSubscriptionResourceGroups.typescript.md)
- [dataWizUsers](./dataWizUsers.typescript.md)
- [hostConfigRuleAssociations](./hostConfigRuleAssociations.typescript.md)
- [integrationAwsSns](./integrationAwsSns.typescript.md)
